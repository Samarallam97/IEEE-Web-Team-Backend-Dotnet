...
namespace Northwind
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            //var londonCustomersNames = Customers.Where(c => c.City == "London")
            //                                                    .Select(c=> c.CompanyName);

            //var londonCustomersNames = from c in Customers
            //                           where c.City == "London"
            //                           select c.CompanyName;

            //foreach (var name in londonCustomersNames)
            //{
            ...
            //var orders = Orders.Join(Shippers, o => o.ShipVia, s => s.ShipperID, (o, s) => new { order = o, shipper = s })
            //                                                                        .Where(e => e.shipper.CompanyName == "Speedy Express")
            //                                                                        .Select(e => e.order);
            ...
            //var count = Orders.Where(o => o.CustomerID == "BONAP").Count();
            //var count = (from o in Orders
            //            where o.CustomerID == "BONAP"
            //            select o).Count();
            ...
            //var managersIds = Employees.Where(e => e.ReportsTo != null )
            //                                          .Select(e => e.ReportsTo)
            //                                          .Distinct();

            //foreach (var id in managersIds)
            //{
            ...
            //}
            ////////////////////////////////////////////////////////////////
            //var managers = Employees.Join(Employees, e => e.ReportsTo, m => m.EmployeeID, m => m);
            #endregion

            #region 6. Find products that are discontinued.
            //var producsts = Products.Where(p => p.Discontinued);
            //foreach (var product in producsts)
            //{
            //    Console.WriteLine(product);
            //}
            #endregion
            ...
            //var suppliers = Suppliers.Select(s => new { s.ContactName, s.Phone });
            ...
            var producsts = Products.Join(Categories, p => p.CategoryID, c => c.CategoryID, (p, c) => new { producst = p, category = c })
